...
public class LSM6 extends I2cControllerPortDeviceImpl implements HardwareDevice, I2cController.I2cPortReadyCallback {
    ...
    public LSM6(I2cController module, int physicalPort, I2cAddr i2cAddr) {
    ...
    public LSM6(I2cController module, int physicalPort) {
